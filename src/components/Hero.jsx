          ...
          <div>
            <div>
              <div className="inline-flex items-center space-x-2 px-3 sm:px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700">
                <Sparkles className="w-4 h-4 text-bluee-400" />
                <span className="text-xs sm:text-sm text-blue-300">
                  Welcome to Gensei Anime
                </span>
              </div>
              ...
              <p className="text-md sm:text-base lg:text-lg text-gray-400 max-w-2xl mx-auto lg:mx-0 mb-6 sm:mb-8 animate-in slide-in-from-bottom duration-700 delay-200 leading-relaxed">
                Find your next Anime here on Gensei Anime. Get ready to binge
                watch your next obsession and many more to come! Are you ready
                to go on your next adventure? Let's find out!
              </p>
                ...
                <div className="p-3 sm:p-4 relative h-full">
                  ...
                  <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-auto">
                    <button
                      ...
                      className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg border ${activeTab === "Popular" ? "bg-blue-500/30 text-white border-blue-400/20" : "bg-white/5 text-gray-300 border-white/10 hover:bg-white/10"} transition-all duration-200 whitespace-nowrap`}
                    >
                      Popular
                    </button>
                    ...
                    <button
                      ...
                      className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg border ${activeTab === "New" ? "bg-blue-500/30 text-white border-blue-400/20" : "bg-white/5 text-gray-300 border-white/10 hover:bg-white/10"} transition-all duration-200 whitespace-nowrap`}
                    >
                      New
                    </button>

                    <button
                      onClick={() => setActiveTab("This Season")}
                      className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg border ${activeTab === "This Season" ? "bg-blue-500/30 text-white border-blue-400/20" : "bg-white/5 text-gray-300 border-white/10 hover:bg-white/10"} transition-all duration-200 whitespace-nowrap`}
                    >
                      This Season
                    </button>
                  </div>
