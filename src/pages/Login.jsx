...
import { BookDashed, LineSquiggle, Mail, Lock } from "lucide-react";
...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert("Logged in (demo). Wire this to your backend next.");
  };
      ...
      <div className="w-full max-w-xl relative">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 max-w-md mx-auto">
            Log in to save your favorites, track your watchlist, and personalize your vibe.
          </p>
        </div>
        ...
        <div className="mt-8 text-center text-gray-500 text-xs">
          Demo page only — connect this to your backend auth when ready.
        </div>
      </div>
    </section>
  );
